...
(2) **Phase out**
  ...
  (D) *Decision review periods*
    ...
    (i) *Pending applications* — In the case of an application received under this section before September 30, 2017, the application shall be reviewed in accordance with subsection (f).

    (ii) *New applications* — In the case of an application received under this section on or after September 30, 2017, subsection (f) shall not apply to the application.
