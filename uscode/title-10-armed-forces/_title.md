...
## Chapters
- 1 — DEFINITIONS, RULES OF CONSTRUCTION, CROSS REFERENCES, AND RELATED MATTERS
...
- 19 — CYBER AND INFORMATION OPERATIONS MATTERS
...
- 207 — BUDGETING AND APPROPRIATIONS
- 209 — OPERATIONAL CONTRACT SUPPORT
- 221 — PLANNING AND SOLICITATION GENERALLY
- 222 — INDEPENDENT COST ESTIMATION AND COST ANALYSIS
- 223 — OTHER PROVISIONS RELATING TO PLANNING AND SOLICITATION GENERALLY
- 225 — [Reserved]
- 241 — AWARDING OF CONTRACTS
- 242 — SPECIFIC TYPES OF CONTRACTS
- 243 — OTHER MATTERS RELATING TO AWARDING OF CONTRACTS
- 244 — UNDEFINITIZED CONTRACTUAL ACTIONS
...
- 253 — RAPID ACQUISITION PROCEDURES
- 255 — CONTRACTING WITH OR THROUGH OTHER AGENCIES
- 257 — CONTRACTS FOR LONG-TERM LEASE OR CHARTER OF VESSELS, AIRCRAFT, AND COMBAT VEHICLES
- 258 — OTHER TYPES OF CONTRACTS USED FOR PROCUREMENTS FOR PARTICULAR PURPOSES
- 271 — TRUTHFUL COST OR PRICING DATA (TRUTH IN NEGOTIATIONS)
- 272 — [Reserved]
- 273 — ALLOWABLE COSTS
- 275 — PROPRIETARY CONTRACTOR DATA AND RIGHTS IN TECHNICAL DATA
- 277 — CONTRACT FINANCING
- 279 — CONTRACTOR AUDITS AND ACCOUNTING
- 281 — CLAIMS AND DISPUTES
- 283 — [RESERVED]
- 287 — OTHER CONTRACTING PROGRAMS
- 301 — RESEARCH AND ENGINEERING GENERALLY
- 303 — RESEARCH AND ENGINEERING ACTIVITIES
- 305 — UNIVERSITIES
- 307 — TEST AND EVALUATION
- 321 — GENERAL MATTERS
- 322 — MAJOR SYSTEMS AND MAJOR DEFENSE ACQUISITION PROGRAMS GENERALLY
- 323 — LIFE-CYCLE AND SUSTAINMENT
- 324 — SELECTED ACQUISITION REPORTS
- 325 — COST GROWTH—UNIT COST REPORTS (NUNN-MCCURDY)
- 327 — WEAPON SYSTEMS DEVELOPMENT AND RELATED MATTERS
- 341 — ACQUISITION OF SERVICES GENERALLY
- 343 — [RESERVED]
- 345 — REPEALED]
- 361 — CONTRACT ADMINISTRATION
- 363 — PROHIBITION AND PENALTIES
- 365 — CONTRACTOR WORKFORCE
- 367 — OTHER ADMINISTRATIVE MATTERS
- 381 — DEFENSE INDUSTRIAL BASE GENERALLY
- 382 — POLICIES AND PLANNING
- 383 — DEVELOPMENT, APPLICATION, AND SUPPORT OF DUAL-USE TECHNOLOGIES
- 384 — MANUFACTURING TECHNOLOGY
- 385 — OTHER TECHNOLOGY BASE POLICIES AND PROGRAMS
- 387 — SMALL BUSINESS PROGRAMS
- 388 — PROCUREMENT TECHNICAL ASSISTANCE COOPERATIVE AGREEMENT PROGRAM
- 389 — LOAN GUARANTEE PROGRAMS
- 551 — MISSILE DEFENSE
- 601 — ORGANIZATIONAL MATTERS
- 602 — NUCLEAR WEAPONS STOCKPILE MATTERS
- 603 — PROLIFERATION MATTERS
- 604 — DEFENSE ENVIRONMENTAL CLEANUP MATTERS
- 605 — SAFEGUARDS AND SECURITY MATTERS
- 606 — PERSONNEL MATTERS
- 607 — BUDGET AND FINANCIAL MANAGEMENT MATTERS
- 608 — ADMINISTRATIVE MATTERS
- 701 — DEFINITIONS
...
- 1413 — ALTERNATIVE PROMOTION AUTHORITY FOR OFFICERS IN DESIGNATED COMPETITIVE CATEGORIES
...
- 2001 — SPACE FORCE PERSONNEL SYSTEM
- 2003 — STATUS AND PARTICIPATION
- 2005 — OFFICERS
- 2007 — ENLISTED MEMBERS
- 2009 — RETENTION AND SEPARATION GENERALLY
- 2011 — SEPARATION OF OFFICERS FOR SUBSTANDARD PERFORMANCE OF DUTY OR FOR CERTAIN OTHER REASONS
- 2013 — VOLUNTARY RETIREMENT FOR LENGTH OF SERVICE
- 2015 — REPORTS
