...
title: 10
chapter: '324'
heading: PROGRAM STATUS–SELECTED ACQUISITION REPORTS
section_count: 9
source: >-
...
#### Effective Date
Section and amendment by Pub. L. 116–283 effective Jan. 1, 2022, with additional provisions for delayed implementation and applicability of existing law, see section 1801(d) of Pub. L. 116–283, set out as a note preceding [section 3001 of this title](./chapter-201-definitions.md#section-3001).
...
(1) The same information, in detailed and summarized form, as is provided in reports submitted under [section 4205 of this title](./chapter-321-general-matters.md#section-4205).

(2) For each major defense acquisition program or designated major subprogram included in the report—

  (A) the Baseline Estimate (as that term is defined in [section 4371(a)(4) of this title](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section4371/a/4&num=0&edition=prelim)), along with the associated risk and sensitivity analysis of that estimate;

  (B) the original Baseline Estimate (as that term is defined in [section 4214(d)(1) of this title](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section4214/d/1&num=0&edition=prelim)), along with the associated risk and sensitivity analysis of that estimate;

  (C) if the original Baseline Estimate was adjusted or revised pursuant to [section 4214(d)(2) of this title](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section4214/d/2&num=0&edition=prelim), such adjusted or revised estimate, along with the associated risk and sensitivity analysis of that estimate; and

  (D) the primary risk parameters associated with the current procurement cost for the program (as that term is used in [section 4355(4) of this title](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section4355/4&num=0&edition=prelim)).
...
(1) with respect to each major defense acquisition program that was included in the most recent comprehensive annual Selected Acquisition Report, the information described in [section 4355 of this title](./chapter-324-program-status-selected-acquisition-reports.md#section-4355); and

(2) with respect to each major defense acquisition program that was not included in the most recent comprehensive annual Selected Acquisition Report, the information described in [section 4353 of this title](./chapter-324-program-status-selected-acquisition-reports.md#section-4353).
...
(1) The same information, in detail and summarized form, as is provided in reports submitted under subsections (b)(1) and (b)(3) of [section 4205 of this title](./chapter-321-general-matters.md#section-4205).
