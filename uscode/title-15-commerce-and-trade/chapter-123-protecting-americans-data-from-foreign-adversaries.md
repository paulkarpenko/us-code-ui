...
title: 15
chapter: '123'
heading: PROTECTING AMERICANS’ DATA FROM FOREIGN ADVERSARIES
section_count: 1
source: >-
...
(1) **Unfair or deceptive acts or practices** — A violation of this section shall be treated as a violation of a rule defining an unfair or a deceptive act or practice under section 18(a)(1)(B) of the Federal Trade Commission Act ([15 U.S.C. 57a(a)(1)(B)](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title15-section57a/a/1/B&num=0&edition=prelim)).
...
(3) **Data broker**
  ...
  (B) *Exclusion* — The term “data broker” does not include an entity to the extent such entity—
    ...
    (iv) is reporting, publishing, or otherwise making available news or information that is available to the general public—
      ...
      (II) not including an obscene visual depiction (as such term is used in [section 1460 of title 18](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title18-section1460&num=0&edition=prelim)); or

    (v) is acting as a service provider.

(4) **Foreign adversary country** — The term “foreign adversary country” means a country specified in [section 4872(d)(2) of title 10](https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title10-section4872/d/2&num=0&edition=prelim).
